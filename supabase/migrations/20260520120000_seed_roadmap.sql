...
values
  ('a1000001-0001-4001-8001-000000000001', 'APTC public launch on Bags', 'Fair SPL launch on Bags with transparent liquidity — initial 2% protocol buy (~20M APTC) at TGE, no VC unlock overhang.', 'Platform', 'in_progress', null, '/litepaper#aptc-token', 10),
  ...
  ('a1000001-0001-4001-8001-000000000006', 'Accumulate protocol holding to 10% (100M APTC)', 'Post-TGE market purchases on Bags, Meteora, and open DEX until treasury holds 10% of max supply — funds community, LP, staking, and ops buckets.', 'Governance', 'in_progress', null, '/litepaper#aptc-allocation', 25),
  ...
  ('a1000001-0001-4001-8001-000000000009', 'Automated GGR → APTC buyback pipeline', 'Scheduled open-market buys from gross gaming revenue with configurable burn, staker, treasury, and market splits.', 'Platform', 'planned', null, '/litepaper#ggr-flywheel', 40),
  ...
  ('a1000001-0001-4001-8001-000000000014', 'Move contract third-party audit', 'Independent security review of Aptos game modules and treasury paths before scaling TVL and external integrations.', 'Security', 'planned', null, '/litepaper#security', 65),
  ...
  ('a1000001-0001-4001-8001-000000000018', 'Quarterly treasury transparency report', 'Published breakdown of GGR, buybacks, burns, staking emissions, and partnership grants — aligned with the 100M APTC allocation chart.', 'Governance', 'planned', null, '/litepaper#aptc-allocation', 85),
  ...
  ('a1000001-0001-4001-8001-000000000021', 'Sui chain adapter live', 'Third live play chain in the registry — Sui house balance mode, treasury env, and provably fair game API routes.', 'Platform', 'planned', null, '/litepaper#multichain-topology', 100),
  ('a1000001-0001-4001-8001-000000000022', 'APTC holder governance (parameter votes)', 'Community votes on buyback %, burn ratio, referral cliff, and staking emission — starting with off-chain signaling, moving on-chain.', 'Governance', 'planned', null, '/litepaper#roadmap', 105),
  ('a1000001-0001-4001-8001-000000000023', 'EVM play chain (Base)', 'Server house balance on Base with the same chain registry pattern — unified profile and leaderboard across Solana, Aptos, and EVM.', 'Platform', 'planned', null, '/litepaper#multichain-topology', 110),
  ...
  ('a1000001-0001-4001-8001-000000000025', 'Developer SDK for provably-fair games', 'Open hub API for third-party builders to publish games with revenue share, shared RNG proofs, and APTC fee routing.', 'Platform', 'planned', null, '/litepaper#scope', 120),
  ...
  ('a1000001-0001-4001-8001-000000000029', 'Multichain game marketplace', 'Largest transparent GambleFi hub — listed third-party games, creator revenue share, and unified APTC economics across chains.', 'Platform', 'planned', null, '/litepaper#roadmap', 140),
