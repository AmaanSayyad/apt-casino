...
VALUES
  ('a1000001-0001-4001-8001-000000000001', 'APTC TGE on Raydium CPMM', '120M APTC + 37 SOL on Raydium Standard AMM · 0.5% fee tier · ~$5k liquidity · ~$20.8k launch MC. Mint revoked. Nine wallets. Sniper-ready.', 'Platform', 'in_progress', null, 'https://aptcasino.fun/litepaper#aptc-token', 10),
  ...
  ('a1000001-0001-4001-8001-000000000036', 'Nine-wallet transparency dashboard', 'Live tracker for all labeled APTC wallets — treasury, staking, referrals, marketing, competitions — with Solscan links and movement alerts.', 'Governance', 'planned', null, 'https://aptcasino.fun/litepaper#aptc-allocation', 78),
