...
function compactApt(n) {
  ...
  if (abs > 0) return n.toFixed(6).replace(/(\.\d*?[1-9])0+$/, '$1');
  return '0';
}
    ...
    <Paper
      ...
      sx={{
        ...
        '&::before': {
          ...
          width: '100%',
          height: '5px',
          background: 'linear-gradient(90deg, #FFA500, #ec4899, #681DDB)',
        },
      }}
    >
      <Typography
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 1, mb: 3 }}>
        ...
        {!loading && !error && rows.length === 0 && (
          <Box sx={{ textAlign: 'center', py: 4, color: 'rgba(255,255,255,0.6)' }}>
            <Typography variant="body2">No Plinko rounds played yet.</Typography>
            <Typography variant="caption" sx={{ display: 'block', mt: 1, color: 'rgba(255,255,255,0.4)' }}>
              Be the first — your wallet appears here once you drop a ball.
            </Typography>
          </Box>
        )}
            ...
            <Box key={id} sx={{ mb: 2 }}>
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mr: 2, flexGrow: 1, minWidth: 0 }}>
                    <Avatar
                    ...
                    <Box sx={{ minWidth: 0 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mt: 0.5, flexWrap: 'wrap' }}>
                        <Tooltip title="Share of rounds with net profit (payout above bet)">
                        ...
                        {winStreak > 0 && (
                          <Tooltip title={`${winStreak} win streak`}>
                            ...
                            >
                              <FaFire color="#ec4899" size={12} />
                              <Typography variant="caption" color="#f9a8d4" fontWeight="bold">
                                {winStreak}
                              </Typography>
                            </Box>
                          </Tooltip>
                  ...
                  >
                    ...
                    >
                      ...
                      <StatBlock
                        ...
                        accent={pnlColor}
                      />
                      {lastSeen && <StatBlock label="Last active" value={lastSeen} />}
                    </Box>
                  </Box>
                </Collapse>
              </Box>
      ...
      >
        ...
        <Box
          component={Link}
          href="/leaderboard?game=plinko&metric=pnl&period=all"
          sx={{
            display: 'flex',
            alignItems: 'center',
            gap: 0.5,
