...
export function getReferralBroadcastBody() {
  return [
    'Craziest thing I have ever seen, @aptcasino on @solana x @aptos x @bagsapp',
    '',
    '50:50 chance casino in the world, first time, fair roulette/mines/plinko/spin wheel like @stake',
    '',
    'literally money making machine, they are sharing their earnings with you, just by sharing the referral link with your friends, you earn 2% of their revenue',
    '',
