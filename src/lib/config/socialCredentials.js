/**
 * Public social proof — hackathon wins, grants, marquee copy.
 */

export const HACKATHON_WIN_COUNT = 15;

export const HACKATHON_WINNER_LABEL = `${HACKATHON_WIN_COUNT}× global hackathon winner`;
